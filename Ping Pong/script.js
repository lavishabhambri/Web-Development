...
(function () {
    ...
    if (rod === "null" || maxScore === "null") { // First turn of the game
        alert("This is the first time you are playing this game. LET'S START!");
        maxScore = 0;
        rod = "Rod1"
    } else { // The previous turns are saved due to local storage
...
function resetBoard(rodName) {
    ...
    // Lossing player gets the ball - rodName is the lossing player
    if (rodName === rod2Name) {
...
function storeWin(rod, score) {
    // Update max score and the rod name
    if (score > maxScore) {
        maxScore = score;
